 ...
 ;( function() {
  var data = {
    pieChart  : [
      {
        color       : 'red',
        // description : 'This represents people who found a job in tech',
        title       : 'Employed in Tech',
        value       : (info.employedTech/totalPeople).toFixed(2)
      },
      {
        color       : 'blue',
        // description : 'This represents people who found a job outside of tech',
        title       : 'Employed in other',
        value       : (info.employedElse/totalPeople).toFixed(2)
      },
      {
        color       : 'green',
        // description : 'This represents how many people are still a student',
        title       : 'Student',
        value       : (info.studentNum/totalPeople).toFixed(2)
      },
      {
        color       : 'purple',
        // description : 'This represents people who are seeking for a job',
        title       : 'Seeking for a job',
        value       : (info.noJob/totalPeople).toFixed(2)
      }
    ]
  };
